...
import Styles from './twitterCard.less';
...
class TwitterCard extends Component {
    ...
    redirectToActions() {
        this.props.history.push('/actions/twitter')
    }
        ...
        return (
            <div>
                <Col span={8} className={Styles.boxCol} onClick={this.props.isActive ? this.redirectToActions.bind(this) : this.startAuth}>
                    <Card bordered={false} className={Styles.boxCard} style={this.props.isActive ? { backgroundColor: 'rgb(0, 171, 236)' } : { backgroundColor: 'rgba(0, 0, 0, 0.85)' }}>
                        <img src="https://assets.ifttt.com/images/channels/2/icons/on_color_large.png" alt="Twitter" title="Twitter" />
                        <span>Twitter</span>
                    </Card>
                </Col>
            </div>
